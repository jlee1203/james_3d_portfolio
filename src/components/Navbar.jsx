...
import { Link } from 'react-router-dom'; //To link us to different parts of webpage
  ...
  return (
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        <Link
          to="/" //Simply using Link tag and this to="/" redirects to top
          className="flex items-center gap-2"
          onClick={() => {
            setActive("");
            window.scrollTo(0, 0) //scrolls to top of window 
          }}
        >
          <img src={logo} alt="logo" className='w-9 h-9 object-contain'/>
            <p className='text-white text-[18px] 
            font-bold cursor-pointer flex'>James Lee&nbsp;
